        ...
        <div className="flex items-center justify-center ">
          <form className="flex flex-col w-full md:w-1/2">
            <input
              ...
              className="p-2 text-gray-600 bg-transparent border-2 rounded-md focus:outline-none"
            />
            <input
              type="text"
              name="email"
              placeholder="Enter your email"
              className="p-2 my-4 text-gray-600 bg-transparent border-2 rounded-md focus:outline-none"
            />
            <textarea
              name="message"
